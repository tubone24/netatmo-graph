        ...
        .then((resp2) => {
          ...
          const moduleData = {
            data: {
              ...
              timeUtc,
              homeReachable,
              homeTemperature: homeTemperature.toFixed(2),
              homeCO2: homeCO2.toFixed(2),
              homeHumidity: homeHumidity.toFixed(2),
              homeNoise: homeNoise.toFixed(2),
              homePressure: homePressure.toFixed(2),
              homeAbsolutePressure: homeAbsolutePressure.toFixed(2),
              homeMinTemp: homeMinTemp.toFixed(2),
              homeMaxTemp: homeMaxTemp.toFixed(2),
              outdoorTemperature: outdoorTemperature.toFixed(2),
              outdoorHumidity: outdoorHumidity.toFixed(2),
              outdoorMinTemp: outdoorMinTemp.toFixed(2),
              outdoorMaxTemp: outdoorMaxTemp.toFixed(2),
              indoorTemperature2: indoorTemperature2.toFixed(2),
              indoorHumidity2: indoorHumidity2.toFixed(2),
              indoorMinTemp2: indoorMinTemp2.toFixed(2),
              indoorMaxTemp2: indoorMaxTemp2.toFixed(2),
              indoorCo22: indoorCo22.toFixed(2),
              rain: rain.toFixed(2),
              sumRain1: sumRain1.toFixed(2),
              sumRain24: sumRain24.toFixed(2),
              windStrength: windStrength.toFixed(2),
              windAngle: windAngle.toFixed(2),
              gustStrength: gustStrength.toFixed(2),
              gustAngle: gustAngle.toFixed(2),
              maxWindStr: maxWindStr.toFixed(2),
              maxWindAngle: maxWindAngle.toFixed(2),
            },
          }
          faunadbClient
